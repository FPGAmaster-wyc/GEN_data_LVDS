...
add wave -noupdate -expand -group UART /tb_top/DUT/txd
add wave -noupdate -expand -group UART /tb_top/DUT/tx_flag
add wave -noupdate -expand -group VCAP /tb_top/DUT/lvds_clk
add wave -noupdate -expand -group VCAP /tb_top/DUT/data1_r
add wave -noupdate -expand -group VCAP /tb_top/DUT/data2_r
add wave -noupdate -expand -group VCAP /tb_top/DUT/sync_r
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {999068 ps} 0}
